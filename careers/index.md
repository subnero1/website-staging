...
<section class="g4x-section careers" style="background-color: #F8FAFC;">
  <div class="row large">
  <!-- job post -->
    <div class="full-column job-col">
      <div class="column-content">
        <div class="card-svg">
          <svg viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M17 12a5 5 0 1 1-5-5"/><path d="M14 2.2q-.97-.198-2-.2C6.477 2 2 6.477 2 12s4.477 10 10 10s10-4.477 10-10q-.002-1.03-.2-2"/><path stroke-linejoin="round" d="m12.03 11.963l4.553-4.553m3.157-3.065l-.553-1.988a.48.48 0 0 0-.761-.24c-1.436 1.173-3 2.754-1.723 5.247c2.574 1.2 4.044-.418 5.17-1.779a.486.486 0 0 0-.248-.775z"/></g></svg>
        </div>
        <div>
          <h5 class="text-xl capitalize-none normal-spacing text-600">Technical Marketing & Evangelism Executive</h5>
          <p class="m0">We are looking for a Technical Marketing & Evangelism Executive who can bridge the gap between technology and communication — someone who understands our products and can craft compelling stories around how they solve real-world challenges underwater.</p>
        </div>
      </div>
    ...
    <dialog id="configModal" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="main">
          ...
          <div class="main modal-content-item" data-product="job-01">
            ...
            <h4>How to Apply</h4>
            <ul>
              <li><a href="https://www.mycareersfuture.gov.sg/job/944e75e31e5c3c794e5d9622cd03595c" target="blank">Apply at MyCareersFuture</a></li>
              <li>Send your resume and a cover letter detailing your relevant experience to `hr (at) subnero (dot) com`. Please include links to your portfolio or relevant projects, if applicable.</li>
            </ul>
          </div>          
        </div>
