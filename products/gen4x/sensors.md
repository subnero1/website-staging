  ...
  <section class="intro category-container">
    <div class="category-row">
      <div class="large-5 columns">
        <!-- <img src="{{site.baseurl}}/images/gen4x/sensor-01.png" /> -->
        <div class="product-images">
          <img id="main-img" class="product-img" src="{{site.baseurl}}/images/gen4x/sensor-01.png">
          <div class="thumbs">
            <img class="selected-thumb" src="{{site.baseurl}}/images/gen4x/sensor-01.png">
            <img src="{{site.baseurl}}/images/gen4x/sensor-02.png">
            <img src="{{site.baseurl}}/images/gen4x/sensor-04.png">
          </div>
        </div>
      </div>
