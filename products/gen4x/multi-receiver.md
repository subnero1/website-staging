...
<div class="product-details">
        ...
        <div class="product-images">
            <div class="main-slider">
              <div class="slider-track">
                <img class="main-img" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-gallery-01.png" alt="Additional Receiving Channels">
                <img class="main-img" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-gallery-02.png" alt="Additional Receiving Channels">
                <img class="main-img" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-gallery-03.png" alt="Additional Receiving Channels">
                <img class="main-img" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-gallery-04.png" alt="Additional Receiving Channels">
              </div>
            </div>
            <div class="thumbs">
              <img class="selected-thumb" data-index="0" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-thumb-01.png" alt="Additional Receiving Channels">
              <img data-index="1" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-thumb-02.png" alt="Additional Receiving Channels">
              <img data-index="2" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-thumb-03.png" alt="Additional Receiving Channels">
              <img data-index="3" src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-thumb-04.png" alt="Additional Receiving Channels">
            </div>
          </div>
      </div>
  ...
  <section class="features category-container">
    <div class="category-row">
      ...
      <div class="large-5 columns">
        <img src="{{site.baseurl}}/images/gen4x/M25M-silver-mr-feature.png" alt="Additional Receiving Channels" />
      </div>
    </div>
  </section>
      ...
      <div class="large-4 columns">
        ...
        <div class=brochures>
          <a class="download-file" href="{{site.baseurl}}/brochures/gen4x-MR-Modems.pdf" target="_blank">
            <img src="{{site.baseurl}}/brochures/gen4x-MR-Modems.jpg" alt="Subnero Multi-Receiver modems brochure" >
