  ...
  <section class="intro category-container">
    <div class="category-row">
      <div class="large-5 columns">
        <img src="{{site.baseurl}}/images/gen4x/WNC-S40HSS4X-01.png" />
      </div>
  ...
  <section class="technical category-container">
    <div class="category-row">
      ...
      <div class="large-8 columns">
        ...
        <p class="upgrade-info">* Upgrades available. <a href="{{site.baseurl}}/products/gen4x/index.html?category=Accessories">Read more.</a></p>
      </div>
    </div>
  </section>
