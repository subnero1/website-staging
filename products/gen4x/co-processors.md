        ...
        <div class="product-images">
          <div class="main-slider">
            <div class="slider-track">
              <img class="main-img" src="{{site.baseurl}}/images/gen4x/coprocessor-01.png" alt="Product Image 1">
              <img class="main-img" src="{{site.baseurl}}/images/gen4x/coprocessor-02.png" alt="Product Image 2">
              <img class="main-img" src="{{site.baseurl}}/images/gen4x/coprocessor-03.png" alt="Product Image 3">
              <img class="main-img" src="{{site.baseurl}}/images/gen4x/coprocessor-04.png" alt="Product Image 4">
            </div>
          </div>
          <div class="thumbs">
