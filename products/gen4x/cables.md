  ...
  <section class="intro category-container">
    <div class="category-row">
      <div class="large-5 columns">
        <!-- <img src="{{site.baseurl}}/images/gen4x/cable-01.png" /> -->
        <div class="product-images">
          <img id="main-img" class="product-img" src="{{site.baseurl}}/images/gen4x/cable-01.png">
          <div class="thumbs">
            <img class="selected-thumb" src="{{site.baseurl}}/images/gen4x/cable-01.png">
            <img src="{{site.baseurl}}/images/gen4x/cable-02.png">
            <img src="{{site.baseurl}}/images/gen4x/cable-03.png">
            <img src="{{site.baseurl}}/images/gen4x/cable-04.png">
          </div>
        </div>
      </div>
