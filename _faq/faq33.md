...
Yes, Subnero modems support acoustic ranging out-of-the-box using the [`ranging` agent](https://unetstack.net/handbook/unet-handbook_ranging_and_synchronization.html). With appropriate upgrades, the multi-receiver modems can function as USBL systems for positioning and tracking.
