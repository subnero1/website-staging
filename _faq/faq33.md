...
Yes, Subnero modems support acoustic ranging out-of-the-box using the [`ranging` agent](https://org-arl.github.io/unet/handbook/313_ranging.html). With appropriate upgrades, the multi-receiver modems can function as USBL systems for positioning and tracking.
