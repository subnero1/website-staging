...
<section class="g4x-section">
  <div class="row large who-section">
    <div class="large-6 columns"> 
      ...
      <p class="text-slate-400">For builders creating the next generation of underwater hardware.</p>
    </div>
    <div class="large-6 columns">
      <div class="who-grid">
        <div class="who-card">
