...
Subnero and Wuxi Smartsea Technology jointly participated in the iOceans Conference held in Sanya from 25–27 October 2019. Visitors to the event were able to learn more about [Subnero’s underwater wireless communication nodes](https://subnero.com/products), the [UnetStack software framework](https://subnero.com/products/unet), and the Subnero Water Assessment Network (SWAN).
