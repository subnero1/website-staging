...
> This is a legacy product and is now replaced with the [multi-channel modems](https://subnero.com/products/wnc-m25mss4+xch.html). This product is not available for purchase anymore.
