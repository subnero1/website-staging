...
<div class="user-stories">
  ...
  <section class="story-section">
    ...
    <div class="list-styled">
      ...
      <div class="result-card scalable">
        <div class="result-icon">
